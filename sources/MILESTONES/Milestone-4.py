...
from numpy import array, linspace, cos, sin, zeros, size
...
#CSF = plt.contourf(x, y1, stab_region, levels = [0, 1],  colors=['#C0C0C0'] ) #levels = [0.5, 1, 1.5]
#CS = plt.contour(x, y1, stab_region, levels = [0.5, 1, 1.5] ) 
plt.plot([0,0],[1,-1], 'o-', color = 'grey')
for t in range(3):
